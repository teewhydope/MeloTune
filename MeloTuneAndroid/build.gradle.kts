...
dependencies { implementation(project(":shared"))
    ...
    implementation(Accompanist.accompanistInset)
    implementation(Accompanist.accompanistInsetUi)
    ...
    implementation(Landscapist.landscapistGlide)
    implementation(Landscapist.landscapistCoil)
    implementation(Landscapist.landscapistFresco)
